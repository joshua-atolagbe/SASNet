...
class ComplexAttributes():
    ...
    def create_array(self, darray, kernel=None, preview=None):
        ...
        necessary ghosting as needed for operations utilizing windowed functions.
        ...
        -------
        darray : Dask Array
        chunk_init : tuple (len 3), chunk size before ghosting
        """
    ...
    def cosine_instantaneous_phase(self, darray, preview=None):
        ...
        Description
        -----------
        Compute the Cosine of Instantaneous Phase of the input data
        ...
        result = da.cos(da.deg2rad(phase))
    ...
    def relative_amplitude_change(self, darray, preview=None):
        ...
        result = sp().first_derivative(env, axis=-1)
    ...
    def response_phase(self, darray, preview=None):
        ...
        env     = self.envelope(darray)
        phase   = self.instantaneous_phase(darray)
        troughs = env.map_blocks(util.local_events, comparator=np.less, dtype=darray.dtype)
